...
if (typeof cs142MakeMultiFilter !== "function") {
  ...
  var secondArray = [1, 2, 3, 4, 6, 7, 9, 8, 11, 15];
  ...
  if (typeof filterFunc !== "function") {
    ...
    result = filterFuncTwo(
      ...
      function(callbackResult) {
        if (!arraysAreTheSame([2, 3, 4, 6, 7, 9, 8, 11, 15], callbackResult)) {
          console.error(
        ...
        if (!arraysAreTheSame([1, 2, 3, 4, 6, 7, 9, 8, 11, 15], this)) {
          console.error(
            "filter function callback does not pass original array as this",
            this
          );
...
if (typeof Cs142TemplateProcessor !== "function") {
  ...
  var dictionary = { month_unana: "July", day_unana: "1", year_unana: "2016" };
